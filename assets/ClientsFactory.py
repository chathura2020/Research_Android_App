...
#------------------------------------------------------------------------------
def main(protocol,ipaddress,data,port):
    ...
    #dataSize=""
    #if(featureList&LARGE_DATA):
    #    dataSize="Large"
    #elif (featureList&MEDIUM_DATA):
    #    dataSize="Medium"
    #elif (featureList&SMALL_DATA):
    #    dataSize="Samll"
    #elif (featureList&VERY_SMALL_DATA):
    #    dataSize="VerySamll"
    
    networkFactory=NetworkClientFactory()
      
    socket=NetworkClientFactory.get_client(protocol,ipaddress,port)
    respond=socket.send_data("This is a sample data "+data)
